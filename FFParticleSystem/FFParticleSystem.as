...
package classes.FFParticleSystem
{
	import classes.FFParticleSystem.Frame;
	import classes.FFParticleSystem.Particle;
	import classes.FFParticleSystem.SystemOptions;
	import classes.FFParticleSystem.ColorArgb;
	...
	public class FFParticleSystem extends DisplayObject implements IAnimatable
	{
		...
		public static function init(poolSize:uint = 16383, fixed:Boolean = false, bufferSize:uint = 0, numberOfBuffers:uint = 1):void
		{
			...
			Starling.current.stage3D.addEventListener(flash.events.Event.CONTEXT3D_CREATE, onContextCreated);
		}
